const u = (globalThis._RU_YT_HF_BASE || "https://huggingface.co/diffusionstudio/piper-voices/resolve/main"), B = (globalThis._RU_YT_ORT_BASE || "https://cdnjs.cloudflare.com/ajax/libs/onnxruntime-web/1.18.0/"), x = (globalThis._RU_YT_PIPER_WASM_BASE || "https://cdn.jsdelivr.net/npm/@diffusionstudio/piper-wasm@1.0.0/build/piper_phonemize"), c = {
...
async function N(e, m) {
  h = h ?? await import("./piper-phonemize-loader.js"), _ = _ ?? await import(globalThis._RU_YT_ORT_MODULE_URL);
